...
The above model will only be able to achieve one of the two goals i.e to predict customers who will churn. We can’t use the above model to identify the important features for churn, mainly because PCA usually creates components which are not easy to interpret.
...
After identifying important predictors, to visualise - we can use plots, summary tables etc. which best conveys the importance of features.

Finally, provide recommended strategies to manage customer churn based on our observations.
